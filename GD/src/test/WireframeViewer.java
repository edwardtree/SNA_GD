...
public class WireframeViewer extends Applet
   ...
   public void init() {
      ...
      init_vertices = new Point3D[ n ];
      
      double lat=0,lng=0, lat_radian, lng_radian, x_coordinate, y_coordinate,z_coordinate; //initial angel\
      ...
      init_vertices[i] = new Point3D( x_coordinate, y_coordinate, z_coordinate );
     ...
     // lat+=10; 
      ...
      vertices = new Point3D[ count_vertice ];
      
      edges = new Edge[ count_edges ];
      
      for(i=0;i<count_vertice;i++){
    	  
    	  vertices[i] = new Point3D( init_vertices[i].x, init_vertices[i].y, init_vertices[i].z );
      }
