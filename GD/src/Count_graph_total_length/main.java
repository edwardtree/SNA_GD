...
public class main {
	...
	public static void main(String[] args) {
		...
		File f = new File("C:/Users/firestation/workspace/Graph drawing/src/Count_graph_total_length/10_vertices_9_edges.txt");
 ...
 */
		...
		*/
		...
		for( i=0 ; i<m ; i++ )
		{
			...
			{	
				System.out.printf("final_bundling_Edges_set_element_sum[i] =" + final_bundling_Edges_set_element_sum[i] + "\n");
		...
		double Not_bundling_total_length = 0;
		double Bundling_total_length = 0;
		
		for( i = 0 ; i < m ; i++)
		{
			Not_bundling_total_length += length(vertice_arr[graph_edges_numbers[0][i]].x-vertice_arr[graph_edges_numbers[1][i]].x,vertice_arr[graph_edges_numbers[0][i]].y-vertice_arr[graph_edges_numbers[1][i]].y);
			System.out.printf("i = %d	%f\n",i,length(vertice_arr[graph_edges_numbers[0][i]].x-vertice_arr[graph_edges_numbers[1][i]].x,vertice_arr[graph_edges_numbers[0][i]].y-vertice_arr[graph_edges_numbers[1][i]].y));
		}
		System.out.printf("\n");
		for( i = 0 ; i < total_edges_number ; i++)
		{
			Bundling_total_length += length(vertice_and_draft_arr[every_bundling_edge_number[0][i]].x-vertice_and_draft_arr[every_bundling_edge_number[1][i]].x,vertice_and_draft_arr[every_bundling_edge_number[0][i]].y-vertice_and_draft_arr[every_bundling_edge_number[1][i]].y);
			System.out.printf("j = %d	%f\n",i, length(vertice_and_draft_arr[every_bundling_edge_number[0][i]].x-vertice_and_draft_arr[every_bundling_edge_number[1][i]].x,vertice_and_draft_arr[every_bundling_edge_number[0][i]].y-vertice_and_draft_arr[every_bundling_edge_number[1][i]].y));
		}
		
		System.out.printf("Not_bundling_total_length =" + Not_bundling_total_length + "  Bundling_total_length =" + Bundling_total_length + "\n");
		
		System.out.printf("draft_number =" + ((n_draft_number_tmp-n)/2) + "  total_edges_number =" + total_edges_number + "  m =" + m + "  aa =" + aa +"\n");
		...
		try {
		    PrintStream out = new PrintStream(new FileOutputStream("C:/Users/firestation/workspace/Graph drawing/src/Count_graph_total_length/Before_edges_bundling.txt"));
		    ...
		    for( i=0 ; i<m ; i++) 
		    	out.println(graph_edges_numbers[0][i] + " " + graph_edges_numbers[1][i] +"\n");
		...
		try {
		    PrintStream out = new PrintStream(new FileOutputStream("C:/Users/firestation/workspace/Graph drawing/src/Count_graph_total_length/After_edges_bundling.txt"));
